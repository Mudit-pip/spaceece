...
public class track_food_fitness_vaccination extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        Request request = new Request.Builder()
                .url("http://43.205.45.96/Growth_Tracker/api_fetchWeeklyDetails.php?u_id=3812&date=" + todayDate)
                .build();
                    ...
                    try {
                        ...
                        if ("success".equals(status)) {
                            ...
                            runOnUiThread(() -> {
                                ...
                                fruit.setText("Fruits: " + finalTotalFruits);
                                vege.setText("Vegetables: " + finalTotalVegetables);
